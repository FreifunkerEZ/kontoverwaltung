...
/**
 * call this to get rid of a rule or tag.
 * runs a post-request, then reloads the page when successful.
 * 
 * @param {element} button determines the ID of what you want to get rid of.
 * @param {string} action sets the RPC-call.
 * @returns {undefined}
 */
...
/**
 * use this to indicate if AJAX-events are running.
 * displays a spinning cog-wheel at the top-left.
 * 
 * @param {integer} diff if a loading-event started, use 1.
 * if it finished use -1.
 * @returns {undefined}
 */
...
/**
 * call this to add jRange to the luxus-filter-slider
 * @returns {undefined}
 */
